...
public class ChatEntity {
	...
	{		
		...
		//mtvTranslate = sbArr0[8];添加翻译字段不可用，素组索引出错
	}
	...
	public String gettvTranslat() {
		return mtvTranslate;
	}

	public void settvTranslate(String tvTranslate) {
		this.mtvTranslate = tvTranslate;
	}
