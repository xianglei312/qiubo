...
public class FriendListAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView,
		...
		if (isOnline == 1) {
			...
			holder.mIcon.setBackgroundResource(getChild(groupPosition, childPosition).getAvatarId() == 0
					? R.drawable.cb0_h001 : R.drawable.cb0_h003);
		} else {
			holder.mIcon = (ImageView) convertView.findViewById(R.id.cc0_friend_list_item_avatar);
			holder.mIcon.setBackgroundResource(getChild(groupPosition, childPosition).getAvatarId() == 0
					? R.drawable.cb0_h001_dark : R.drawable.cb0_h003_dark);
		}
