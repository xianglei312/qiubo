...
import futureChange.HomeTabView;
import futureChange.HomeTabView.OnCheckListener;
...
public class MainBodyActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tabBar = (HomeTabView) findViewById(R.id.tabBar);

		tabBar.setOnCheckListener(new OnCheckListener() {
		...
		// mTabContacts.setOnClickListener(new
		// MainBodyOnClickListener(mTabNumContacts));
		// mTabFriends.setOnClickListener(new
		// MainBodyOnClickListener(mTabNumFriends));
		// mTabSettings.setOnClickListener(new
		// MainBodyOnClickListener(mTabNumSettings));
		...
		View viewFriendSearch = li.inflate(R.layout.friendround, null);
