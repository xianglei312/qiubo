...
public class FriendListPage implements OnChildClickListener {
	...
	public void onCreate() {
		...
		mListView.setGroupIndicator(mContext0.getResources().getDrawable(R.drawable.expander_floder));

		mBtnBack.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				MainBodyActivity.getInstance().gotoPage(MainBodyActivity.mTabNumContacts,
						MainBodyActivity.mPageChooseRoom);
			}
		});
	...
	private void initData() {
		...
		mGrpInfo.add(new FriendListGroupItem(mContext0.getString(R.string.friendslist), curListFriends.size()));
