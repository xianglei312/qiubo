...
public class MainTabMsgPage implements OnClickListener {
	...
	public void onCreate() {
		...
		mViewOfPage.findViewById(R.id.imgMainMine).setOnClickListener(this);
	...
	public void onUpdateByUserinfo(UserInfo user, String sentence, String time, boolean updateNotif) {
		...
		mListOfEntity.add(0, new TabMsgItemEntity(user.getId(), user.getAvatarId(), user.getName(), sentence, time));
	...
	public void onUpdateById(int id, int avatarId, String name, String sentence, String time, boolean updateNotif) {
	...
	public void onUpdateNotification(int id, String sentence) {
		...
		mNotification.setLatestEventInfo(mContext0, "   ", sentence, contentIntent);
		NotificationManager mNotificationManager = (NotificationManager) mContext0
