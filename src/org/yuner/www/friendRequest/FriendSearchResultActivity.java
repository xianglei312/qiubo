		...
		mListviewOfResults.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (mySelf.getId() == requestee.getId()) {
					alertDialogBuilder.setMessage(R.string.you_can_not_add_yourself).setCancelable(true)
					...
					alertDialogBuilder.setMessage(R.string.are_you_sure_send_request).setCancelable(true)
						...
						public void onClick(DialogInterface dialog, int id) {
							...
							reqEnt0.accept();
							NetworkService.getInstance().sendUpload(GlobalMsgTypes.msgFriendshipRequest,
									reqEnt0.toString());
							startActivity(new Intent(FriendSearchResultActivity.this,MainBodyActivity.class));
						}
					...
					alertDialogBuilder.setMessage(R.string.sorry_you_are_friend_already).setCancelable(true)
							.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int id) {
							dialog.cancel();
						}
