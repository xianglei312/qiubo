...
public class ADGoodsBuyHistory extends Activity {
	private int jine = 0;
	private int jinea = 0;
...
//		textviewc = (TextView) findViewById(R.id.buy_textviewc);
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case 0:
				new AlertDialog.Builder(ADGoodsBuyHistory.this)
...
//				textviewc.setText(money + " " + getString(R.string.buy_yuan));
			...
			case 7:
				...
				int regulara = Integer.parseInt(regular);
				radioButton = getRadioButton();
				radioButton.setText(getString(R.string.buy_regular) + regulara
						 + getString(R.string.buy_yuan));
			...
			case 8:
				...
				int fasta = Integer.parseInt(fast);
				radioButton = getRadioButton();
				radioButton.setText(getString(R.string.buy_fast) + fasta
						+ getString(R.string.buy_yuan));
				radioButton.setOnClickListener(new View.OnClickListener() {
			...
			case 9:
				...
				int emsa = Integer.parseInt(ems);
				radioButton = getRadioButton();
				radioButton.setText(getString(R.string.buy_ems) + emsa
						+ getString(R.string.buy_yuan));
				radioButton.setOnClickListener(new View.OnClickListener() {
...
//								intent.setClass(ADGoodsBuyHistory.this,
