...
public class ADGoodsConsultHistory extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Buttonfdate.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				DatePickerDialog dpd = new DatePickerDialog(
						ADGoodsConsultHistory.this, dsl, calendar.get(Calendar.YEAR),
		...
		Buttonftime.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Calendar calendar = Calendar.getInstance(Locale.CHINA);
			    new TimePickerDialog(ADGoodsConsultHistory.this, new TimePickerDialog.OnTimeSetListener() {
...
//								intent.setClass(ADGoodsConsultHistory.this,ADHistoryDetailed.class);
//								startActivity(intent);
								overridePendingTransition(R.anim.push_left_in,
										R.anim.push_left_out);
								ADGoodsConsultHistory.this.finish();
							} else {
								msg.what = 2;
								msg.obj = this
