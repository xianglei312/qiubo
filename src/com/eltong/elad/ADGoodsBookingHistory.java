...
public class ADGoodsBookingHistory extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Buttonfdate.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				DatePickerDialog dpd = new DatePickerDialog(
						ADGoodsBookingHistory.this, dsl, calendar.get(Calendar.YEAR),
		...
		Buttonftime.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Calendar calendar = Calendar.getInstance(Locale.CHINA);
			    new TimePickerDialog(ADGoodsBookingHistory.this, new TimePickerDialog.OnTimeSetListener() {
			...
			new Thread() {
				public void run() {
					...
					InputStream is = AppliedMethod.doPostSubmit(
							BasicProperties.HTTP_URL_BOOKING,
							strParam.toString());
...
//		String strtele = edittextc.getText().toString();
//		String regex = "1\\d{10}";
					...
					case XmlPullParser.START_TAG:
						if (BasicProperties.XML_TAG67.equals(nodeName)) {
							...
							if (AddBooking.equals("1")) {
								msg.what = 1;
								msg.obj = this
										.getString(R.string.booking_request_right);
								handler.sendMessage(msg);						
								
//								Intent intent = new Intent();
//								intent.setClass(ADGoodsBookingHistory.this,ADHistoryDetailed.class);
//								startActivity(intent);
								overridePendingTransition(R.anim.push_left_in,
										R.anim.push_left_out);
								ADGoodsBookingHistory.this.finish();
							} else {
								msg.what = 2;
								msg.obj = this
